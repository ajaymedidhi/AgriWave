  ...
  <> 
    ...
    <div className="privacy-cont">
      <div className="privacy-policy">
        ...
        <p>
        The deadline for canceling an order is 30 days from the date you received the goods or on which 
        a third party you have appointed, who is not the carrier, takes possession of the product 
        delivered.
        ...
        <p>
        You can inform us of your decision by e-mail info@proptelligence.net
        </p>  
        <p>We will reimburse you no later than 30 days from the day on which we receive the returned 
...
any fees for such reimbursement.</p>
       ...
       <ul className='p-list-cont'>
        ...
        <li>The supply of goods which are, after delivery, according to their nature, inseparably 
            mixed with other items</li>
       </ul>
       <p>We reserve the right to refuse returns of any merchandise that does not meet the above return 
conditions at our sole discretion.</p>
<h3>Returning Goods</h3>
    <p>
    You are responsible for the cost and risk of returning the goods to us. You should send the goods 
...
receive a gift credit for the value of your return. Once the returned product is received, a gift 
